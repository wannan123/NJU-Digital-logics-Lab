...
VL_INLINE_OPT void Vencode83___024root___ico_sequent__TOP__0(Vencode83___024root* vlSelf) {
    ...
    __Vtableidx2 = 0;
    // Body
    __Vtableidx1 = vlSelf->sw;
    vlSelf->pos = Vencode83__ConstPool__TABLE_h4b50c69d_0
        [__Vtableidx1];
    vlSelf->ledr = Vencode83__ConstPool__TABLE_h3dc06102_0
        [__Vtableidx1];
    __Vtableidx2 = (((IData)(vlSelf->pos) << 1U) | 
                    (1U & ((IData)(vlSelf->pos) >> 3U)));
    vlSelf->seg0 = Vencode83__ConstPool__TABLE_heb8d3ae3_0
        [__Vtableidx2];
}
...
#endif
                VL_FATAL_MT("/home/wannan/Desktop/NJU-Digital-logics-Lab/lab2-Encoder/vsrc/encode83.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/wannan/Desktop/NJU-Digital-logics-Lab/lab2-Encoder/vsrc/encode83.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/wannan/Desktop/NJU-Digital-logics-Lab/lab2-Encoder/vsrc/encode83.v", 1, "", "NBA region did not converge.");
            }
...
void Vencode83___024root___eval_debug_assertions(Vencode83___024root* vlSelf) {
    ...
    // Body
    if (VL_UNLIKELY((vlSelf->sw & 0xfe00U))) {
